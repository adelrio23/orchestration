...
export class Coordinator {
  ...
  parsePlan(text, basis) {
    ...
    if (!Array.isArray(raw.questions) || raw.questions.length > 3 || !Array.isArray(raw.tasks) || raw.tasks.length > 3) throw Error('Plan must contain at most 3 milestones and 3 questions');
