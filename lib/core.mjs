...
export const defaults = { maxCalls: 60, maxAttempts: 2, concurrency: 1, maxTasks: 100, timeoutMs: 300000, testTimeoutMs: 60000, maxOutputBytes: 2000000, maxContextChars: 40000, maxFiles: 40, maxRepairRounds: 2, maxMilestones: 8, maxPlanningRounds: 6 };
...
export class Coordinator {
  ...
  setLimits(body) {
    ...
    const ranges = { maxCalls: [1, 1000], maxAttempts: [1, 6], concurrency: [1, 4], maxTasks: [1, 500], timeoutMs: [1000, 1800000], testTimeoutMs: [1000, 900000], maxOutputBytes: [10000, 5000000], maxContextChars: [6000, 200000], maxFiles: [1, 60], maxRepairRounds: [0, 6], maxMilestones: [1, 12], maxPlanningRounds: [0, 50] };
