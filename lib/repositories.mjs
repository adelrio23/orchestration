...
function idle(engine) { if (engine.state.mode !== 'paused' || engine.running.size || engine.integrating || engine.chatting || engine.githubBusy || engine.state.recoveryRequired) throw Error('Pause, recover interruptions and drain active work first'); }
