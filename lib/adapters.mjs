...
export function invocation(name, config, prompt, role, cwd) {
  ...
  if (name === 'codex') return { command: config.command, args: ['exec', ...modelArgs, '--ignore-user-config', '-c', 'approval_policy="never"', ...(researching ? ['--search'] : []), '--ephemeral', '--sandbox', 'read-only', '--json', '--color', 'never', '-'], input: prompt };
